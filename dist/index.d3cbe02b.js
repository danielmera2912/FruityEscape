...
window.addEventListener("scroll", function() {
    ...
    for(var i = 0; i < secciones.length; i++)// Verifica si la sección actual está a menos de 100 vh del borde superior de la pantalla
    if (secciones[i].getBoundingClientRect().top <= 100) {
        ...
        for(var j = 0; j < enlaces.length; j++)enlaces[j].classList.remove("activa");
